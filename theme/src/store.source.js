/*
  ⚠️ هذا الملف للقراءة والتعديل فقط — لا تلصقه بالمتجر!
  اللي ينلصق بالمتجر هو theme/store.js (سطر واحد).
  بعد أي تعديل هنا: npx terser theme/src/store.source.js -c -m --comments false -o theme/store.js
*/
(function () {
  /* ================= الإعدادات =================
